...
@Entity({ name: 'business_application_role_history' })
export class BusinessApplicationRoleHistory {
  @PrimaryGeneratedColumn({ name: 'business_application_role_history_id' })
  businessApplicationRoleHistoryId: number;

  @Column({ name: 'business_application_role_id' })
